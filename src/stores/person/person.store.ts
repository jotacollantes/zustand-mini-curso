...
//! Separamos la logica del manejo del state creando el objeto storeAPi que sera incluido en usePersonStore. Para poder mostrar el nombre de la accion que se esta ejecutando en redux dev tool tenemos que anadir los argumentos false que serivira para mantener el estado (Ex. para poder seguir escribiendo en en un input) y no reemplazarlo,  y el 'nombre-de-la-accion' al metodo set. Tambien es necesario inluir la interfaz [ [ "zustand/devtools", never ] ] al type StateCreator.
